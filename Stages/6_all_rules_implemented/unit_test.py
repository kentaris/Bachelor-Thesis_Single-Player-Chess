class units: #TODO: currently only positions where white starts are allowed. easy to change tough
    ...
    AD=['5/R4/5/5/p4','5/5/5/5/R4'] #OK#rook captures pawn horizontally
    ...
    AL=['1q3/4B/2Q2/5/Rb2r','1Q3/4b/5/5/4R'] #OK#2 queens 2 rooks 2 bishops
    AM=['2N2/nrpb1/3R1/PNR2/rQ1Bn','PNbQr/nr3/1R1RN/2n1B/2p2'] ##keyboard interrupt#lots of movements with all pieces EXCLUDING king
    AN=['1K3/2p2/3p1/5/5','5/5/2K2/3p/5'] #OK#king captures black pawnn chain from behind (protected)
    AO=['2K2/krpb1/3R1/PNR2/rQ1Bn','PKbQr/kr3/1R1RN/2n1B/2p2'] ###<<<<NO PLAN FOUND>>>>lots of movements with all pieces INCLUDING king
    AP=['3n1/1n3/2K2/5/5','3K1/5/5/5/5'] #OK#king captures knight protected by a knight. TODO: here something strange happens... the king moves more than he needs to. I'm not sure if the problem is the planner itself or if I'm somehow preventing my piece from capturing. I tested a bit with unprotected knights in the same position and the same happens...
    AQ=['1b3/2r2/3K1/5/5','1K3/5/5/5/5'] ##Keyboard interrupt#king captures rook protected by a bishop
